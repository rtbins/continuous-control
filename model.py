...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fc_units1=512, fc_units2=256, dropout=0.2):
...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fcs1_units=512, fc2_units=256, fc3_units=128, dropout=0.2):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
